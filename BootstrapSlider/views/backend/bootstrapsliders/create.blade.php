...
@section('title'){{ "Whole CMS Yeni Slider Ekle" }}@endsection
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase"> Yeni Slider Ekle</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    @include('backend::_errors.error')
                    {!! Form::open(['method' => 'post','route'=>['admin.bootstrapslider.store'],'class'=>'form-horizontal','role'=>'form']) !!}
                        <div class="form-body">
