...
@section('title'){{ "Whole CMS Slider Düzenle" }}@endsection
...
@section('page_breadcrumb')
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.bootstrapslider.index') }}">Sliderlar</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="#">Slider Düzenle</a>
        </li>
    </ul>
@endsection
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">Slider Düzenle</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    @include('backend::_errors.error')
                    {!! Form::model($slider,['method' => 'put','route'=>['admin.bootstrapslider.update',$slider->id],'class'=>'form-horizontal','role'=>'form']) !!}
                    <div class="form-body">
                        @include('backend::bootstrapsliders._form')
                    </div>
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                {!! Form::submit("Düzenle",['class'=>'btn blue']) !!}
                                <a href="{{ URL::route('admin.bootstrapslider.index') }}" class="btn default">İptal Et</a>
                            </div>
                        </div>
                    </div>
                    </form>
